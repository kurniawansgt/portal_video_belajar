...
insert  into `initial_company`(`id`,`company_name`,`username`,`database_name`,`logo`,`bgfile`) values (1,'Data Integration','admin','g_form','data_integration_1.png','data_integration_1.png');
...
CREATE TABLE `m_url_gform` (
  ...
  `url_gform` varchar(255) DEFAULT NULL,
  `save_to_db` enum('0','1') DEFAULT NULL,
...
insert  into `m_url_gform`(`id`,`nama_dokumen`,`url_gform_response`,`url_gform`,`save_to_db`,`user_id`,`active`,`created_date`,`updated_date`,`ip_address`) values (1,'Registrasi Santri Baru Griya Ceria','https://docs.google.com/spreadsheets/d/e/2PACX-1vRrZ2-7qBuSHLq0AfyRxLvv1n_goDK-y6FA_OR_b0EKFi3X4n0R1BlyKqCOU_27zmxHyMRtU5CsHzbf/pub?output=csv','https://forms.gle/izMbxFtyTuvQCiyv9','1','skurniawan','1','2020-07-11 15:46:59','2020-07-11 15:46:59','127.0.0.1');
insert  into `m_url_gform`(`id`,`nama_dokumen`,`url_gform_response`,`url_gform`,`save_to_db`,`user_id`,`active`,`created_date`,`updated_date`,`ip_address`) values (2,'Registrasi Peserta Seminar Teknologi','https://docs.google.com/spreadsheets/d/e/2PACX-1vQmJMQDfjU6znOs0TBjw1bH-RwHeSjM3m7Qf_5jaff7Xvc6Dauy9ZbxTwIqO1491HsrFEFCUuvuT-VJ/pub?output=csv',NULL,NULL,'spratiwi','1','2020-07-09 06:51:36','2020-07-09 06:51:36','127.0.0.1');
...
insert  into `master_group_detail`(`id`,`groupcode`,`module`,`read`,`confirm`,`entry`,`update`,`delete`,`print`,`export`,`import`,`entrytime`,`entryuser`,`entryip`,`updatetime`,`updateuser`,`updateip`) values (30,'Pengajar','MASTER_MODULE',0,0,0,0,0,0,0,0,'2020-07-13 02:58:22','admin','127.0.0.1','2020-07-13 02:58:22','admin','127.0.0.1');
insert  into `master_group_detail`(`id`,`groupcode`,`module`,`read`,`confirm`,`entry`,`update`,`delete`,`print`,`export`,`import`,`entrytime`,`entryuser`,`entryip`,`updatetime`,`updateuser`,`updateip`) values (31,'Pengajar','GRAPH_QUERY',0,0,0,0,0,0,0,0,'2020-07-13 02:58:22','admin','127.0.0.1','2020-07-13 02:58:22','admin','127.0.0.1');
insert  into `master_group_detail`(`id`,`groupcode`,`module`,`read`,`confirm`,`entry`,`update`,`delete`,`print`,`export`,`import`,`entrytime`,`entryuser`,`entryip`,`updatetime`,`updateuser`,`updateip`) values (32,'Pengajar','GRAB_DATA_GFORM',1,1,1,1,1,1,1,1,'2020-07-13 02:58:22','admin','127.0.0.1','2020-07-13 02:58:22','admin','127.0.0.1');
insert  into `master_group_detail`(`id`,`groupcode`,`module`,`read`,`confirm`,`entry`,`update`,`delete`,`print`,`export`,`import`,`entrytime`,`entryuser`,`entryip`,`updatetime`,`updateuser`,`updateip`) values (29,'Pengajar','MASTER_GROUP',0,0,0,0,0,0,0,0,'2020-07-13 02:58:22','admin','127.0.0.1','2020-07-13 02:58:22','admin','127.0.0.1');
insert  into `master_group_detail`(`id`,`groupcode`,`module`,`read`,`confirm`,`entry`,`update`,`delete`,`print`,`export`,`import`,`entrytime`,`entryuser`,`entryip`,`updatetime`,`updateuser`,`updateip`) values (28,'Pengajar','MASTER_USER',0,0,0,0,0,0,0,0,'2020-07-13 02:58:22','admin','127.0.0.1','2020-07-13 02:58:22','admin','127.0.0.1');
insert  into `master_group_detail`(`id`,`groupcode`,`module`,`read`,`confirm`,`entry`,`update`,`delete`,`print`,`export`,`import`,`entrytime`,`entryuser`,`entryip`,`updatetime`,`updateuser`,`updateip`) values (27,'Pengajar','REPORT',0,0,0,0,0,0,0,0,'2020-07-13 02:58:22','admin','127.0.0.1','2020-07-13 02:58:22','admin','127.0.0.1');
insert  into `master_group_detail`(`id`,`groupcode`,`module`,`read`,`confirm`,`entry`,`update`,`delete`,`print`,`export`,`import`,`entrytime`,`entryuser`,`entryip`,`updatetime`,`updateuser`,`updateip`) values (25,'Pengajar','DASHBOARD',0,0,0,0,0,0,0,0,'2020-07-13 02:58:21','admin','127.0.0.1','2020-07-13 02:58:21','admin','127.0.0.1');
insert  into `master_group_detail`(`id`,`groupcode`,`module`,`read`,`confirm`,`entry`,`update`,`delete`,`print`,`export`,`import`,`entrytime`,`entryuser`,`entryip`,`updatetime`,`updateuser`,`updateip`) values (26,'Pengajar','ADMIN',1,0,0,0,0,0,0,0,'2020-07-13 02:58:22','admin','127.0.0.1','2020-07-13 02:58:22','admin','127.0.0.1');
insert  into `master_group_detail`(`id`,`groupcode`,`module`,`read`,`confirm`,`entry`,`update`,`delete`,`print`,`export`,`import`,`entrytime`,`entryuser`,`entryip`,`updatetime`,`updateuser`,`updateip`) values (33,'Pengajar','VIDEO_PEMBELAJARAN_SISWA',1,0,0,0,0,0,0,0,'2020-07-15 09:08:54','admin','127.0.0.1','2020-07-13 02:58:22','admin','127.0.0.1');
insert  into `master_group_detail`(`id`,`groupcode`,`module`,`read`,`confirm`,`entry`,`update`,`delete`,`print`,`export`,`import`,`entrytime`,`entryuser`,`entryip`,`updatetime`,`updateuser`,`updateip`) values (34,'Pengajar','PENGATURAN_VIDEO_PEMBELAJARAN',1,1,1,1,1,1,1,1,'2020-07-13 02:58:22','admin','127.0.0.1','2020-07-13 02:58:22','admin','127.0.0.1');
insert  into `master_group_detail`(`id`,`groupcode`,`module`,`read`,`confirm`,`entry`,`update`,`delete`,`print`,`export`,`import`,`entrytime`,`entryuser`,`entryip`,`updatetime`,`updateuser`,`updateip`) values (35,'Admin','DASHBOARD',0,0,0,0,0,0,0,0,'2020-09-02 10:53:33','admin','127.0.0.1','2020-09-02 10:53:33','admin','127.0.0.1');
insert  into `master_group_detail`(`id`,`groupcode`,`module`,`read`,`confirm`,`entry`,`update`,`delete`,`print`,`export`,`import`,`entrytime`,`entryuser`,`entryip`,`updatetime`,`updateuser`,`updateip`) values (36,'Admin','ADMIN',0,0,0,0,0,0,0,0,'2020-09-02 10:53:33','admin','127.0.0.1','2020-09-02 10:53:33','admin','127.0.0.1');
insert  into `master_group_detail`(`id`,`groupcode`,`module`,`read`,`confirm`,`entry`,`update`,`delete`,`print`,`export`,`import`,`entrytime`,`entryuser`,`entryip`,`updatetime`,`updateuser`,`updateip`) values (37,'Admin','REPORT',0,0,0,0,0,0,0,0,'2020-09-02 10:53:33','admin','127.0.0.1','2020-09-02 10:53:33','admin','127.0.0.1');
insert  into `master_group_detail`(`id`,`groupcode`,`module`,`read`,`confirm`,`entry`,`update`,`delete`,`print`,`export`,`import`,`entrytime`,`entryuser`,`entryip`,`updatetime`,`updateuser`,`updateip`) values (38,'Admin','MASTER_USER',0,0,0,0,0,0,0,0,'2020-09-02 10:53:33','admin','127.0.0.1','2020-09-02 10:53:33','admin','127.0.0.1');
insert  into `master_group_detail`(`id`,`groupcode`,`module`,`read`,`confirm`,`entry`,`update`,`delete`,`print`,`export`,`import`,`entrytime`,`entryuser`,`entryip`,`updatetime`,`updateuser`,`updateip`) values (39,'Admin','MASTER_GROUP',0,0,0,0,0,0,0,0,'2020-09-02 10:53:33','admin','127.0.0.1','2020-09-02 10:53:33','admin','127.0.0.1');
insert  into `master_group_detail`(`id`,`groupcode`,`module`,`read`,`confirm`,`entry`,`update`,`delete`,`print`,`export`,`import`,`entrytime`,`entryuser`,`entryip`,`updatetime`,`updateuser`,`updateip`) values (40,'Admin','MASTER_MODULE',0,0,0,0,0,0,0,0,'2020-09-02 10:53:33','admin','127.0.0.1','2020-09-02 10:53:33','admin','127.0.0.1');
insert  into `master_group_detail`(`id`,`groupcode`,`module`,`read`,`confirm`,`entry`,`update`,`delete`,`print`,`export`,`import`,`entrytime`,`entryuser`,`entryip`,`updatetime`,`updateuser`,`updateip`) values (41,'Admin','GRAPH_QUERY',0,0,0,0,0,0,0,0,'2020-09-02 10:53:33','admin','127.0.0.1','2020-09-02 10:53:33','admin','127.0.0.1');
insert  into `master_group_detail`(`id`,`groupcode`,`module`,`read`,`confirm`,`entry`,`update`,`delete`,`print`,`export`,`import`,`entrytime`,`entryuser`,`entryip`,`updatetime`,`updateuser`,`updateip`) values (42,'Admin','GRAB_DATA_GFORM',0,0,0,0,0,0,0,0,'2020-09-02 10:53:33','admin','127.0.0.1','2020-09-02 10:53:33','admin','127.0.0.1');
insert  into `master_group_detail`(`id`,`groupcode`,`module`,`read`,`confirm`,`entry`,`update`,`delete`,`print`,`export`,`import`,`entrytime`,`entryuser`,`entryip`,`updatetime`,`updateuser`,`updateip`) values (43,'Admin','VIDEO_PEMBELAJARAN_SISWA',0,0,0,0,0,0,0,0,'2020-09-02 10:53:33','admin','127.0.0.1','2020-09-02 10:53:33','admin','127.0.0.1');
insert  into `master_group_detail`(`id`,`groupcode`,`module`,`read`,`confirm`,`entry`,`update`,`delete`,`print`,`export`,`import`,`entrytime`,`entryuser`,`entryip`,`updatetime`,`updateuser`,`updateip`) values (44,'Admin','PENGATURAN_VIDEO_PEMBELAJARAN',1,1,1,1,1,1,1,1,'2020-09-02 10:53:33','admin','127.0.0.1','2020-09-02 10:53:33','admin','127.0.0.1');
...
insert  into `registrasi_santri_baru_griya_ceria`(`Alamat_Rumah`,`Jenis_Kelamin_Calon_Siswa`,`Nama_Calon_Santri`,`Nama_Wali_Santri`,`No_Handphone`,`Timestamp`,`id`) values ('Bekasi','Laki-laki','Ikhsan Mulia','Rudiyanto','08933313133','11/07/2020 22:50:04',11);
insert  into `registrasi_santri_baru_griya_ceria`(`Alamat_Rumah`,`Jenis_Kelamin_Calon_Siswa`,`Nama_Calon_Santri`,`Nama_Wali_Santri`,`No_Handphone`,`Timestamp`,`id`) values ('Bekasi','Laki-laki','Ikhsan Mulia','Rudiyanto','08998313133','11/07/2020 22:53:14',12);
...
insert  into `video_pembelajaran`(`id`,`judul_video`,`deskripsi_video`,`thumbnail_video`,`url_video`,`url_form`) values (3,'Proposal Yayasan','Proposal Yayasan','logo_youtube_kecil.png','https://youtu.be/3ikzaMYfTjA','https://forms.gle/1cD74L1qhqJ9u5Kf7');
