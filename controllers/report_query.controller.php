<?php
	...
	function generatetableview($sql, $sumall=0, $subtotal = 0, $rowstart = 0 ){	           
            ...
            $closeDiv = "</div>";
            $opentable = "<table id=\"tblData\" class=\"table-bordered1\"  width=\"95%\" >";
            $closetable = "</table>";
            ...
            if($jmlRow > 0){
                foreach ($result as $row) {
                    ...
                    if($subtotal == 1) {
                        ...
                        if ($bsubfirst) {
                            ...
                            for($k=0; $k<$fields_cnt; $k++){	
                                if ($k>0){
                                    $q = number_format($arraysub[$k]) == 0 ? "" : number_format($arraysub[$k]);
                                }else{
                                    $q = "Sub Total";                                    
                                }
                    ...
                    for ($j = 0; $j < $fields_cnt; $j++){
                        ...
                        if($j == 0){
                            ...
                            $isidetail = "<td align=\"right\" class=\"Default\">".number_format($row[$col['name']])."</td>";
                        }else{
                ...
                if($sumall==1) {
                    ...
                    for($i=0; $i<$fields_cnt; $i++){	
                        if ($i>0){
                            $q = number_format($arraysum[$i]) == 0 ? "" : number_format($arraysum[$i]);
                        }else{
                            if($arraysum[0]){
                                $q = "Total";
                            } else {
