...
//        return $result ? array($uploaded_image_path, $thumbnail_image_path) : false;
    ...
    function getMailInbox(){
        ...
        'username' 	=> 'kurniawan.sgt@gmail.com',
        'password' 	=> 'sgtsnt010786'
        )
        );
        ...
        $emails[] = imap_search($stream, 'SINCE '. date('d-M-Y',strtotime("-100 week")));
        ...
        echo "Message 1: ".$message."<br>";
        echo "Message 2: ".$messageExcerpt."<br>";
        echo "Message 3: ".$partialMessage."<br>";
        echo $date."<br>";
        echo "========================================================<br><br>";
        }*/
