<?php
    ...
    class report_queryControllerGenerate
    {
	    ...
	    $sql .= "`entryuser` = '".$this->toolsController->replacecharSave($this->report_query->getEntryuser(),$this->dbh)."',";
	    $sql .= "`entryip` = '".$this->toolsController->replacecharSave($this->report_query->getEntryip(),$this->dbh)."',";
