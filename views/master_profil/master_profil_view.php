    ...
    <table >       
        <tr> 
            <td align="center" colspan="3">                                
                <?php if($master_profil->getAvatar()!=""){ ?>
                ...
                <?php } else { ?>
                <img src='images_small/no-profile.png'>
                <?php 
                }
                if($bowner) {                        
                ?>
                    <br>
                    <a href ="#" onclick="showMenu('uploadphoto','index.php?model=master_profil&action=formUpload')">Rubah Gambar Profil</a>
                <?php
                }       
                ?> 
